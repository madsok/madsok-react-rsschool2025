        ...
        return (
            <>
                ...
                <div className='controls-wrapper'>
                    <input className='search-field' type="text" onChange={this.handleSearchInput} />
                    <button className='search-button' onClick={this.handleSearchButton}>Search Button</button>
                </div>
            </>
        )
    }
